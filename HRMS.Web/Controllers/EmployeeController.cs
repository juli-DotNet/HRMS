    ...
    public class EmployeeController : Controller
    {
        ...
        private EmployeeViewModel Parse(Employee a)
        {
            return new EmployeeViewModel
            {
                ...
                BirthDateDay = a.BithDate.Day,
                BirthDateMonth = a.BithDate.Month,
                BirthDateYear = a.BithDate.Year,
        ...
        private Employee Parse(EmployeeViewModel a)
        {
            return new Employee
            {
                ...
                Mobile = a.Mobile,
                ContactId = a.ContactId,
                BithDate = new DateTime(a.BirthDateYear, a.BirthDateMonth, a.BirthDateDay),
                AddressId = a.AddressId,
                Address = new Address
                {
                    Id = a.AddressId,
